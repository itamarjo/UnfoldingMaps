...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
	    ...
	    for(Marker marker: markers){
	    	...
	    	if (mag > 5) {
	    		marker.setColor(red);
	    		((SimplePointMarker) marker).setRadius(20); 
	    	}
	    	else if ((mag < 5) && (mag > 4)){
	...
	private Marker createSimplePointMarker(PointFeature point) {
	...
	{	
		...
		rect(25, 50, 150, 300); 
		fill(0); 
		text("Earthquate Key", 50, 80);
		text("5.0 + Magnitute", 70, 130);
		text("4.0 + Magnitute", 70, 160);
